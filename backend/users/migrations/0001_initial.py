    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('RECRUITER', 'Recruiter'), ('USER', 'User')],
                 default='USER', help_text='Determines what the user can see and do in the portfolio', max_length=20)),
                ('ai_tools_used', models.JSONField(blank=True, default=list,
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user. Grants all permissions listed to this user.',
